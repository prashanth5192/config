...
" "	silent! exe a:firstline . ',' . a:lastline . 's/\v%(^ *)@<= {'.
" a:width .'}/\t/g'
" "endfunction
"
" """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
" "map <left> <ESC>:MBEbp<RETURN> " left arrow (normal mode) switches buffers
" (excluding minibuf) 
" "map <up> <ESC>:Sex<RETURN><ESC><C-W><C-W> " up arrow (normal mode) brings
" up a file list
" "map <down> <ESC>:Tlist<RETURN> " down arrow  (normal mode) brings up the
" tag list
" "map <A-i> i <ESC>r " alt-i (normal mode) inserts a single char, and then
...
" " Autocommands
" """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" autocmd BufEnter * :syntax sync fromstart " ensure every file does syntax
" highlighting (full)
" au BufNewFile,BufRead *.asp :set ft=aspjscript " all my .asp files ARE
" jscript
